...
function RoomHero({ room }) {
    ...
    useEffect(() => {
        ...
        switch (i18n.language) {
            case "vi":
                setDescription(room.description_vi || room.description);
                break;

            case "zh":
                setDescription(room.description_zh || room.description);
                break;

            case "ko":
                setDescription(room.description_ko || room.description);
                break;
    ...
    }, [room, i18n.language]); // eslint-disable-line
    return (
        <section>
            <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="px-4 py-6 md:pl-10 md:px-5 md:py-10">
                    ...
                    <p className="mt-5 w-full md:w-10/12 text-sm md:text-base">{room && description}</p>
